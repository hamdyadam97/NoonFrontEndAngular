...
export class SidemenuComponent implements OnInit {
  ...
  @Output() dataReturned: EventEmitter<any> = new EventEmitter<any>();
  checkboxChanged(rating: number) {
    // Call function to return data when checkbox is checked
    console.log("Call function to return data when checkbox is checked",rating)
    this._productServiceService
      ...
      .subscribe({
        next: (res) => {
          ...
          this.dataReturned.emit(this.filterproducts);
